...
apk update
apk add ip-full procps-ng-ps bind-rndc bind-server bind-tools bash wget rsync block-mount wipefs coreutils-nohup etherwake nginx-full sfdisk losetup resize2fs luci-ssl-nginx
