...
1. Delete the existing `Master` network, and create a new one.
...
1. Log into [console.redhat.com/openshift/downloads](https://console.redhat.com/openshift/downloads){:target="_blank"} using your [https://developers.redhat.com](https://developers.redhat.com) account.
...
```bash
<PATH_TO_KEY>/<YOUR_SSH_KEY>.pub ${HOME}/openshift-lab/ssh_key.pub
```
